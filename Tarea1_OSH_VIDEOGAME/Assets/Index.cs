...
public class Index: MonoBehaviour
{
    ...
    const string menuHint = "To enter another world: type PORTAL";

    //  These arrays hold the passwords to be used in our game
    string[] level1Passwords = { "Light", "Wings", "Magic", "Power", "Love"};
    string[] level2Passwords = { "Treasure", "Ship", "Seaweed" };
    string[] level3Passwords = { "Weapons", "Defense", "Golems", "Towers" };
    ...
    void ShowMainMenu()
    {
        ...
        //  We show the menu
        Terminal.WriteLine("What world do you want to enter?");
        Terminal.WriteLine("");
        Terminal.WriteLine("Press 1 for: The Forest fairies");
        Terminal.WriteLine("Press 2 for: The Deep Lake ");
        Terminal.WriteLine("Press 3 for: The Village of the Golems");
        Terminal.WriteLine("");
    ...
    private void ShowLevelReward()
    {
        ...
        {
            case 1:
                Terminal.WriteLine("Take the Diamond of the Forest Fairies");
                Terminal.WriteLine(@"
         ______
        /_\/_\/\
        \\ /\ //
         \\/\//
          \\//
           \/         
            ...
            case 2:
                Terminal.WriteLine("Take the Golden Cup");
                Terminal.WriteLine(@"
         _____
        |     |
        |     |
         ...
         |___|         
            ...
            case 3:
                Terminal.WriteLine("Take the Mystical box");
                Terminal.WriteLine(@"
         _______
        |   |   |
        |||||||||
    ...
    private void AskForPassword()
    {
        ...
        //  its characters.
        Terminal.WriteLine("Guess the key to the secret door. Hint: " + password.Anagram());
        Terminal.WriteLine(menuHint);
    }
